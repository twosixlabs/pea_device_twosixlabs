...
public class EmptyItemProvider extends ItemProvider<EmptyItem> {
    ...
    @Override
    protected ItemWrapper<EmptyItem> acquirePrivateData(Bundle params) {
        return new ItemWrapper<EmptyItem>(new EmptyItem()){};
    }
